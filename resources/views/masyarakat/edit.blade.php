                ...
                <form action={{ route('masyarakat.update') }} method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="p-4 bg-gray-500 rounded-md dark:bg-gray-700">
                            ...
                            <input type="text" name="nama" id="nama" class="block w-full p-2 border border-gray-400 rounded" value="{{ $masyarakat->nama }}">
                        </div>
                        ...
                        <div class="p-4 bg-gray-100 rounded-md dark:bg-gray-700">
                            ...
                            <select name="jenis_kelamin" class="block w-full p-2 border border-gray-400 rounded" id="jenis_kelamin">
                        ...
                        <div class="p-4 bg-gray-100 rounded-md dark:bg-gray-700">
                            ...
                            <input type="text" name="nohp" id="nohp" class="block w-full p-2 border border-gray-400 rounded" value="{{ $masyarakat->nohp }}">
                        </div>

                        <!-- Email -->
                        <div class="p-4 bg-gray-100 rounded-md dark:bg-gray-700">
                            <label for="email" class="block mb-2 font-semibold text-gray-900 dark:text-white">Email</label>
                            <input type="email" name="email" id="email" class="block w-full p-2 border border-gray-400 rounded" value="{{ $masyarakat->email }}">
                        </div>

                        <!-- Status -->
                        <div class="p-4 bg-gray-100 rounded-md dark:bg-gray-700">
                            <label for="status" class="block mb-2 font-semibold text-gray-900 dark:text-white">Status</label>
                            <select name="status" id="status" class="block w-full p-2 border border-gray-400 rounded">
                        ...
                        <div class="col-span-2 p-4 bg-gray-100 rounded-md dark:bg-gray-700">
                            ...
                            <textarea name="alamat" class="block w-full p-2 border border-gray-400 rounded" rows="4">{{ $masyarakat->alamat }}</textarea>
                        </div>
